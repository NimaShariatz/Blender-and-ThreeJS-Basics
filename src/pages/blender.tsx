    ...
    <>
      ...
      <div className="content_container">
        ...
        <p>
          ...
          Then <PopupText keybindingText={<span>New Object</span>} keybindingImgVideo={<img src={NewObject}/>} meshOrMenu={false} placerText={"add"}/> the floor that the scene has. A plane will do. You 
          can <PopupText keybindingText={<span>S with optional (X,Y,Z)<br/><small>(should be done in "Edit Mode")</small></span>} keybindingImgVideo={<video src={ScaleAxis} loop muted playsInline/>} meshOrMenu={true} placerText={"make it as large"}/> as you like. Blender units have no fixed meaning. If you scaled it in "Object Mode", you can fix it by <PopupText keybindingText={<span>Transfer Changes to "Edit Mode"</span>} keybindingImgVideo={<img src={TransferScale}/>} meshOrMenu={false} placerText={`transfering the changes to "Edit Mode"`}/>.
        </p>
        <div className="media_item_container">
          <img src={plane}/>
        </div>
      ...
      <div className="content_container">
        ...
        <p>
          ...
          mentioning that you can directly apply "Metallic" and "Roughness" to a <span className="threejs_material_standard">meshStandard</span> or <span className="threejs_material_phyiscal">meshPhysical</span> material by code in ThreeJS which overrides any existing values that come with the Blender model. You can also change/apply color to individual 
          objects by code as well (for any material).
        </p>
